                    ...
                    <main className="main">
                        <section className="title" style={{ padding: matches.small ? '6rem 1rem 3rem 1rem' : null }}>
                            <div className="title-content" style={{ width: matches.medium ? '60%' : matches.small ? '85%' : null }}>
                                <h1 className="title-heading">How it work ?</h1>
                                <p className="title-paragraph">Start working with <a href="/" className="title-link">Landrick</a> that can provide everything you need to generate awareness, drive traffic, connect.</p>
                            </div>
                        </section>
                        <section className="questions" style={{ padding: matches.medium ? "5rem 3rem" : matches.small ? "3rem 1.5rem" : null }}>
                            <div className="questions-row" style={{ width: matches.small ? '90%' : null }}>
                                <div className="question" style={{ padding: matches.medium ? "2rem 1rem" : null, flex: matches.small ? "1 100%" : null }}>
                                    ...
                                    <div className="question-content">
                                        <h2 className="question-heading">How our <a href="/" className="question-link">Landrick</a> work ?</h2>
                                ...
                                <div className="question" style={{ padding: matches.medium ? "2rem 1rem" : null, flex: matches.small ? "1 100%" : null }}>
                                    ...
                                    <div className="question-content">
                                        <h2 className="question-heading">What is the main process open account ?</h2>
                                        <p className="question-paragraph">Lorem ipsum dolor sit amet consectetur adipisicing elit. Est saepe cum perspiciatis beatae minima ut qui nobis eaque odit repellendus, accusamus temporibus obcaecati rerum?</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="questions-row" style={{ width: matches.small ? '90%' : null }}>
                                <div className="question" style={{ padding: matches.medium ? "2rem 1rem" : null, flex: matches.small ? "1 100%" : null }}>
                                    ...
                                    <div className="question-content">
                                        <h2 className="question-heading">How to make unlimited data entry ?</h2>
